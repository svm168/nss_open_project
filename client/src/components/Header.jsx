...
function Header(){
    ...
    return(
        <div className="flex flex-col items-center mt-24 text-center text-black bg-white/30 backdrop-blur-sm border border-white/20 p-10 px-10 rounded-4xl shadow-xl">
