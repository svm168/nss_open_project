...
import { createPaymentIntent, confirmPayment, getUserDonations, getDonationById, getAllDonations, handleStripeWebhook } from '../controllers/payment.controller.js'
...
paymentRouter.get('/donation/:donationId', userAuth, getDonationById)           // Gets a specific donation
